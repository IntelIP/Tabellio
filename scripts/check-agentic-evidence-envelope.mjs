...
const evidencePath = args.evidence ?? "agentic-pr-evidence.json";
...
const result = {
  ...
  status: blockers.length === 0 ? "agentic_evidence_envelope_ready" : "blocked",
...
function validateEvidence(value, localBlockers, localWarnings) {
  ...
  stringEquals(value.schemaVersion, "agentic-git-evidence/v0.1", "schemaVersion", localBlockers);
