...
Released review-cycle and validation-result schemas remain available under immutable versioned filenames. Release execution requires all three canonical control refs, stores custom receipt state outside the worktree, and rechecks live `origin/main` immediately before tag publication.
